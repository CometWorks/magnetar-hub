...
This repo contains plugins for Space Engineers 1 Dedicated Server loaded by the [Magnetar](https://github.com/viktor-ferenczi/Magnetar) loader.

Magnetar is a similar plugin loader to Pulsar, but for the Dedicated Server.
...
If you wish to make a plugin for Magnetar, there are a few steps:
1. Start by using this template: [**Server Plugin Template**](https://github.com/viktor-ferenczi/se-server-plugin-template) (click the green button in the top right corner).
